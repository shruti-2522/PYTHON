...
class Programmer(Emp):
    def __init__(self, name, salary, age, lang):
        self.name = name
        self.salary = salary
        self.age = age
        self.lang = lang
    ...
    def prog_details(self):
        return f"name is:{self.name} and salary is{self.salary} and age is:{self.age} lang are{self.lang}"


shruti = Programmer('Shruti', 35000, 23, ['python', 'c++', 'java'])
print(shruti.prog_details())
